...
export default class Utils {
    ...
    static arrayTagParameter(names: Array<string>, values: Array<string>) {
        let arrOfObjs = [];
    ...
    static arrayTagLowerCaseParameter(names: Array<string>, values: Array<string>) {
        let arrOfObjs = [];
        for (var i = 0; i < names.length; i++) {
            arrOfObjs.push({ "key": names[i], "value": values[i] });
        }
    ...
    static arrayTagKeyParameter(names: Array<string>, values: Array<string>) {
        let arrOfObjs = [];
        for (var i = 0; i < names.length; i++) {
    ...
    static objTagParameter(names: Array<string>, values: Array<string>) {
        let jsonObj:any = {};
        for (var i = 0; i < names.length; i++) {
    ...
    static objTagSetParameter(names: Array<string>, values: Array<string>) {
        let jsonObj : { TagSet:Array<any> } = { "TagSet": [] };
        for (var i = 0; i < names.length; i++) {
            jsonObj.TagSet.push({ "Key": names[i], "Value": values[i] })
        }
        return jsonObj;
    }
    static objTagItemsParameter(names: Array<string>, values: Array<string>) {
        let jsonObj : { Items:Array<any> }= { "Items": [] };
        for (var i = 0; i < names.length; i++) {
    ...
    static returnTagsStrArr(oldTags:any){
        let keys:any = [], values:any = [];
        oldTags.forEach(function (item:any) {
            keys.push(item.Key)
