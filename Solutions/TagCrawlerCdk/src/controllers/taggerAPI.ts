...
const taggerAPI = {
  ...
  tag: (paramsObj:any) => {
    ...
    switch (typeName) {
      ...
      case 'ec2-subnet':
        ...
        break;
      case 'iam':
        retTagResult = taggerAPI.iam(resName, tags)
      case 'lambda':
  ...
  iam: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      let oldTags = utils.returnTagsStrArr(tags)
      let id = resName.split("/")[1]
      let params = {
        RoleName: id,
      ...
      await iam.tagRole(params, function (err:any, data:any) {
        if (err) {
          return {e: err, arn: resName} 
        } else {
          return resolve( {d: data, arn: resName} );
        }
      });
    })
  },
  ec2: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      let oldTags = utils.returnTagsStrArr(tags)
      ...
      await ec2.createTags(params, function (err:any, data:any) {
        if (err) {
  ...
  apigateway: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      let oldTags = utils.returnTagsStrArr(tags)
      let params = {
        resourceArn: resName,
      ...
      await apigateway.tagResource(params, function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          resolve( {d: data, arn: resName} );
  ...
  lambda: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      let oldTags = utils.returnTagsStrArr(tags)
      let params = {
        Resource: resName,
      ...
      await lambda.tagResource(params, function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          resolve( {d: data, arn: resName} );
  ...
  dynamodb: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      let oldTags = utils.returnTagsStrArr(tags)
      let params = {
        ResourceArn: resName,
      ...
      await dynamodb.tagResource(params, function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          resolve( {d: data, arn: resName} );
  ...
  sqs: (resName:string, tags:any) => { // idk need to re-test
    return new Promise(async function (resolve, reject) {
      let oldTags = utils.returnTagsStrArr(tags)
      let params = {
      ...
      await sqs.getQueueUrl(params, async function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          // resolve(data);
          ...
          await sqs.tagQueue(paramsData, function (err:any, data:any) {
            if (err) {
              reject(err);
            } else {
              resolve( {d: data, arn: resName} );
  ...
  logs: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      ...
      await logs.tagLogGroup(params, function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          resolve( {d: data, arn: resName} );
  ...
  rds: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      ...
      await rds.addTagsToResource(params, function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          resolve( {d: data, arn: resName} );
  ...
  sns: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      ...
      await sns.tagResource(params, function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          resolve( {d: data, arn: resName} );
  ...
  cloudfront: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      let oldTags = utils.returnTagsStrArr(tags)
      let params = {
        Resource: resName,
      ...
      await cloudfront.tagResource(params, function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          resolve( {d: data, arn: resName} );
  ...
  kms: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      ...
      await kms.tagResource(params, function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          resolve( {d: data, arn: resName} );
  ...
  s3: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      ...
      await s3.putBucketTagging(params, function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          resolve( {d: data, arn: resName} );
  ...
  cloudwatch: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      let oldTags = utils.returnTagsStrArr(tags)
      let params = {
        ResourceARN: resName,
      ...
      await s3.tagResource(params, function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          resolve( {d: data, arn: resName} );
  ...
  cloudformation: (resName:string, tags:any) => {
    return new Promise(async function (resolve, reject) {
      let oldTags = utils.returnTagsStrArr(tags)
      let params = {
        StackName: resName,
      ...
      await cloudformation.updateStack(params, function (err:any, data:any) {
        if (err) {
          reject( {e: err, arn: resName} );
        } else {
          resolve( {d: data, arn: resName} );
